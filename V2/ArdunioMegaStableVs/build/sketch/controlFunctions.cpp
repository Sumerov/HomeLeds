...
// {turnOff, rgbChanged, brightnessChanged}
bool controlBools[] = {false, false, false};
...
bool getControlAction(uint8_t *rgb) {
  ...
  switch(controlVal) {
    ...
    case 2: { if(brightness<250) brightness += 5; controlBools[2] = true; break;} 
    case 3: { if(brightness>5) brightness-= 5; controlBools[2] = true; break;} 
    case 1: { break;} 
    ...
    //Sipky
    case 18: { rgb[0] += 5; break;} 
    case 28: { rgb[1] += 5; break;} 
    case 38: { rgb[2] += 5; break;} 
    case 4: { break;}
    case 19: { rgb[0] -= 5; break;} 
    case 29: { rgb[1] -= 5; break;} 
    case 39: { rgb[2] -= 5; break;} 
    case 5: { break;}
    //DIY
    case 80: { break;} 
    case 81: { break;} 
